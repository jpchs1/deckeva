	...
	<div class="container-form">
			...
			<form class="form gentech-import" action="<?php echo esc_url( admin_url( 'admin.php?page=gentech-activate-theme-panel' ) ); ?>" method="post">
				<div class="help-description">
					<a href="https://developer.vimeo.com/api/guides/start" target="_blank"><?php esc_html_e('How to get API Key?', 'streamlab-core');?></a>
				</div>
				<div class="form-row">
					
					<div class="form-group">
						<label class="form-label" for="purchase_item"><?php esc_html_e( 'Enter Youtube Developer Api Key', 'streamlab-core' ); ?></label>
						<input class="form-control" placeholder="<?php esc_attr_e( 'Enter Youtube Developer Api Key', 'streamlab-core' ); ?>" type="password" name="api_key" data-type="vimoe" value="<?php echo get_option( 'gen_vimoe_api_key' ); ?>">
					</div>	
