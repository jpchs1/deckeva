	...
	if (hmd_get_current_screen_id() === 'settings_page_head-meta-data') {
		...
		if (!hmd_check_date_expired() && !hmd_dismiss_notice_check()) {
			...
			<div class="notice notice-success">
				<p>
					<strong><?php esc_html_e('Plugin Sale:', 'head-meta-data'); ?></strong> 
					<?php esc_html_e('Save 20% on any of our', 'head-meta-data'); ?> 
					...
					<?php esc_html_e('Apply code', 'head-meta-data'); ?> <code>PLANET2023</code> <?php esc_html_e('at checkout. Sale ends 9/9/23.', 'head-meta-data'); ?> 
...
function hmd_check_date_expired() {
	...
	$expires = apply_filters('hmd_check_date_expired', '2023-09-09');
