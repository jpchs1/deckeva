...
function presscore_action_add_less_vars( The7_Less_Vars_Manager_Interface $less_vars ) {
	...
	if ( the7_elementor_is_active() ) {
		...
		$less_vars->add_pixel_number( 'lg-breakpoint', of_get_option( 'header-mobile-first_switch-after' ) + 1 );
		$less_vars->add_pixel_number( 'md-breakpoint', of_get_option( 'header-mobile-second_switch-after' ) + 1 );
	}
}
